...
\begin{center}
    ...
    \[\sqrt{2} \int_{0}^{\infty }\frac{1}{a^2 + 1 }da = \sqrt{2} \arctan(x)\Big|_0^{\infty} = \frac{\pi}{\sqrt{2}}\]
...
\begin{center}
    ...
    \fbox{\parbox[a]{0.985\linewidth}{\textbf{Solucion:}
            ...
            \[\lim_{n \to \infty} \frac{1}{n} \int_{0}^{n} f(\frac{\lfloor x\rfloor }{n})  \,dx  = \lim_{n \to \infty}\frac{1}{n}\sum_{k= 0}^{n}\-\int_{k}^{k+1} f(\frac{\lfloor x\rfloor }{n})  \,dx   \]
